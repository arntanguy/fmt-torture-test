...
// This file has been imported from mc_rtc/fmt_formatters.h with the goal of quickly testing different version of fmt.
...
#if FMT_VERSION < 9 * 10000
// std::ostream support is automatic, no fmt::streamed support
