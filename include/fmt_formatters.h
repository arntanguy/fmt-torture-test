...
// This file has been imported from mc_rtc/fmt_formatters.h with the goal of
...
struct fmt::formatter<boost::filesystem::path> : fmt::formatter<std::string> {
  ...
  auto format(const boost::filesystem::path& p,
              FormatContext& ctx) FMT_CONST_IF_REQUIRED {
