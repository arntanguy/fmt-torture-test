 ...
 *
 */
inline Eigen::Matrix3d rpyToMat(const double& r, const double& p,
                                const double& y) {
 ...
 *
 */
inline sva::PTransformd rpyToPT(const double& r, const double& p,
                                const double& y) {
...
/** Generic version that can handle a Quaternion or Matrix and returns the RPY
 * angles */
template <typename T>
